...
Then Rise a Renewal Request with  first RPM User 2715
...
Then check the "Approved" status a Renewal Request with  first NOC User 2715
...
Then Request send to FCC of Renewal Request with  first Legal User 2715
...
Then Rise a Renewal Request with  second RPM User 2716
...
Then check the "Rejected" status a Renewal Request with  second NOC User 2716
...
Then Rise a Renewal Request with  third RPM User 2717
...
Then check the "Approved" status a Renewal Request with  third NOC User 2717
