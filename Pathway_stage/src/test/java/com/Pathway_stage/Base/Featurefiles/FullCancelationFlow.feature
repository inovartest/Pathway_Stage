...
Then Rise a full Cancelation Request with first Market User 3113
...
Then check the "Approved" status a Cancelation Request with first RPM User 3113
...
Then check the "Approved" status a Cancelation Request with first NOC User 3113
...
Then Request send to FCC of full cancelation process with  First Legal User 3113
...
Then Rise a Cancelation Request with second Market User 3115
...
Then check the "Rejected" status a Cancelation Request with second RPM User 3115
...
Then Rise a Cancelation Request with Third Market User 3116
...
Then check the "Approved" status a Cancelation Request with Third RPM User 3116
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 3116
...
Then Rise a Cancelation Request with fourth Market User 3120
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 3120
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 3120
...
Then Full cancelation Request reject with  fourth Legal User 3120
...
Then Rise a full Cancelation Request with  fifth RPM User 3121
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 3121
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 3121
...
Then Rise a full Cancelation Request with  sixth RPM User 3124
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 3124
...
Then Rise a full Cancelation Request with  Seventh RPM User 3125
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 3125
